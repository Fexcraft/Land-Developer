...
public class PlayerEvents {
    ...
    public static void onPlayerLogin(PlayerLoggedInEvent event){
		...
		Broadcaster.send(NO_INTERNAL, Channel.SERVER, null, "landdev.server.player_join", player.name_raw());
    }
	...
	public static void onPlayerLogout(PlayerLoggedOutEvent event){
		...
		if(player != null){
			Broadcaster.send(NO_INTERNAL, Channel.SERVER, null, "landdev.server.player_left", player.name_raw());
			player.save();
